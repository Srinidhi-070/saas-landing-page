      ...
      >
        <div>
          ...
          <p className="mt-2 text-center text-sm text-slate-600 dark:text-slate-400">
            Already a member?{' '}
            <a href="#/login" onClick={(e) => handleNavClick(e, '#/login')} className="font-medium text-primary-500 hover:text-primary-600 cursor-pointer">
              Sign in
            </a>
          </p>
        </div>
        <form className="mt-8 space-y-6" action="#" method="POST">
          <div className="space-y-4 rounded-md shadow-sm">
             <div className="relative">
                ...
                />
                <UserIcon className="absolute top-1/2 left-3 -translate-y-1/2 w-5 h-5 text-slate-400" />
            </div>
            <div className="relative">
                <input
                    id="email-address"
